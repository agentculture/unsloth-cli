"""``unsloth-cli learn`` — the learnability affordance.
...
_TEXT = """\
unsloth-cli — a clonable template for AgentCulture mesh agents.
...
Commands
--------
  unsloth-cli whoami             Identity from culture.yaml.
  unsloth-cli learn              This self-teaching prompt.
  unsloth-cli explain <path>...  Markdown docs for any noun/verb path.
  unsloth-cli overview           Descriptive snapshot of the agent.
  unsloth-cli doctor             Check the agent-identity invariants.
  unsloth-cli cli overview       Describe the CLI surface itself.
...
def _as_json_payload() -> dict[str, object]:
    return {
        ...
        "json_support": True,
        "explain_pointer": "unsloth-cli explain <path>",
    }
