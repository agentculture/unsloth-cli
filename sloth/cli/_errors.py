...
Every failure inside unsloth-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`sloth.cli._output`,
...
# Exit-code policy. Documented in ``unsloth-cli learn`` output.
# 0      = success
