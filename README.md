...
- **The canonical guildmaster skill kit** plus the 8 devague operator skills
  under `.claude/skills/`, vendored cite-don't-import. See [`docs/skill-sources.md`](docs/skill-sources.md).
